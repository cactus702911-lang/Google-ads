            ...
            <div class="container mx-auto px-4 md:px-6">
                <div class="flex h-16 items-center justify-between">
                    <a href="/" class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-700" id="logo-text">${headerData.logoText || 'DigitalGrowth'}</span>
                    </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <div class="space-y-4">
                        <a href="/" class="flex items-center gap-2 mb-4">
                            ...
                            <span class="text-xl font-bold" id="footer-logo">DigitalGrowth</span>
                        </a>
